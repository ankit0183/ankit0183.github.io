...
- Reading the file `db.php` gives us `db-name`,`db-user`,`db-pass`
- Use `QUIC protoco`l to access the User Portal on UDP port 443
...
![](/assets/img/posts/quick/image-20200425192116695.png)

The **clients.php** link provides a bigger list of clients with their country.

![](/assets/img/posts/quick/image-20200425192431688.png)
...
![](/assets/img/posts/quick/image-20200425194435794.png)
...
![](/assets/img/posts/quick/image-20200425194602565.png)

## Ticketing system

I went back to the `Testimonials` and client information we found earlier and tried different combination of `domain name`s and `TLDs.` The country indicated in the client list is a hint that allows us to guess the `TLD` instead of fuzzing all possible TLDs.
...
![](/assets/img/posts/quick/image-20200425195036632.png)

![](/assets/img/posts/quick/image-20200425195402958.png)

A random `ticket ID` is generated each time we submit a new ticket.

![](/assets/img/posts/quick/image-20200425195436245.png)

We can then `searc`h for our `ticket` and the content is returned.

![](/assets/img/posts/quick/image-20200425195631981.png)
...
![](/assets/img/posts/quick/image-20200425195918422.png)
...
![](/assets/img/posts/quick/image-20200425201134062.png)

![](/assets/img/posts/quick/image-20200425201200365.png)
...
![](/assets/img/posts/quick/image-20200425201534969.png)

![](/assets/img/posts/quick/image-20200425201623053.png)

After `searching` for the ticket number `7644`, I saw the **shell.sh** file was downloaded from my `machine`.

![](/assets/img/posts/quick/image-20200425201650309.png)

![](/assets/img/posts/quick/image-20200425201707232.png)
...
![](/assets/img/posts/quick/image-20200425202811702.png)
...
![](/assets/img/posts/quick/image-20200425203602880.png)
...
![](/assets/img/posts/quick/image-20200425204523370.png)

We can add printers and point to our IP address:

![](/assets/img/posts/quick/image-20200425204618742.png)

After adding a `printer`, we can see it in the list.

![](/assets/img/posts/quick/image-20200425204637736.png)

After starting a netcat listener on port `9100`, we can click the printer icon on the right to test connectivity. We see there's a link to add a `printe`r job.

![](/assets/img/posts/quick/image-20200425204741174.png)
...
![](/assets/img/posts/quick/image-20200425204811791.png)
...
![](/assets/img/posts/quick/image-20200425212900578.png)
