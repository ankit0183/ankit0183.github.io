...
## Portscan
here ports `21` and `8`- are open apache `2.4.41` is running on the port `80`

```bash
a3nk17@kali:~$ sudo nmap -sC -sV -F 10.10.10.191
...
![](/assets/img/posts/blunder/1.png)
...
![](/assets/img/posts/blunder/3.png)
...
![](/assets/img/posts/blunder/2.png)
...
```bash
a3nk17@kali:~/htb/blunder$ cewl http://blunder.htb > cewl.txt
```

Next, bruteforcing...

and with `wfuzz` i got 2more directories
`/robots.txt` , `/todo.txt`
...
cat /root/root.txt
5d64hfjruytummyt89emtgdyhyikd
```
![](/assets/img/posts/blunder/pwn.png)
